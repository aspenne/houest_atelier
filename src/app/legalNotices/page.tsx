...
import BannerBackLegal from "@/app/assets/BannerBackLegal.png";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center ">
      ...
      <div className="w-full  py-4 px-7 sm:py-16 sm:px-28 flex flex-col justify-between gap-8 text-secondary bg-secondaryLight">
        ...
        <p>
          <b>Propriétaire</b> : Entreprise Individuelle Houeix Elvin EI Capital
          social de 0€ Numéro de TVA: TVA_XXX – 3 rue de la Loire 44340
          Bouguenais
        </p>
        <p>
          <b>Responsable publication</b> : Houeix Elvin –
          contact@houestatelier.fr Le responsable publication est une personne
          physique ou une personne morale.
        </p>
        <p>
          <b>Webmaster</b> : Michelo Axel – axel.mch@outlook.fr
        </p>
        <p>
          <b>Hébergeur</b> : Hostinger – Hostinger, UAB 34, rue Švitrigailos,
        </p>
        03230 03230 Vilnius abuse@hostinger.com
        <p>
          <b>Délégué à la protection des données</b> : Michelo Axel –
          axel.mch@outlook.fr
        </p>
        ...
        <p>
          ...
          <a href="https://housest-atelier.fr">
            https://housest-atelier.fr
          </a>{" "}
        ...
        <p>
          ...
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a> ne
        ...
        <p>
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a> et
        ...
        <p>
          ...
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a> se
        ...
        <p>
          ...
          Houeix Elvin EI.{" "}
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a>est
          représenté par Houeix Elvin, son représentant légal
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            : données de connexion et d’utilisation du Site, date et heure de
            prise de rendez-vous ainsi que tout commentaire sur celui-ci.{" "}
          </li>
        ...
        Houeix Elvin EI – DPO, Michelo Axel au 3 rue de la Loire 44340
        Bouguenais.
        <p>
        ...
        <p>
          ...
          sécurité absolue. Si nous prenions connaissance d&apos;une brèche de
          la sécurité, nous avertirions les utilisateurs concernés afin
          qu&apos;ils puissent prendre les mesures appropriées. Nos procédures
          de notification d’incident tiennent compte de nos obligations légales,
        ...
        <p>
          ...
          être le cas lorsque{" "}
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a> ou
        ...
        <p>
          ...
          <a href="https://housest-atelier.fr">https://housest-atelier.fr</a>. À
